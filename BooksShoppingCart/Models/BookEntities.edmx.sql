...
-- --------------------------------------------------
-- Date Created: 10/03/2018 17:55:25
-- Generated from EDMX file: C:\Users\CPP\Downloads\BooksShoppingCart-master\BooksShoppingCart\Models\BookEntities.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_Products_ToTable]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Products] DROP CONSTRAINT [FK_Products_ToTable];
GO
...
-- Creating foreign key on [AspNetUser_Id] in table 'Orders'
ALTER TABLE [dbo].[Orders]
